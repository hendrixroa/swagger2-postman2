...
Converter = {
  ...
  convert: function (json) {
    ...
    swaggerData.definitions = json.definitions; // global schema defs
    swaggerData.responses = json.responses; // global sample responses

    // Start building out collection:
    this.collection = new Collection();
    this.collection.name = json.info.title;
    this.collection.describe(json.info.description);
    this.collection.variables = _.map(swaggerData.definitions);
